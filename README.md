...
1. Abrir el modal de creación manual para cargar el título, la categoría y links `http(s)` opcionales por cadena; alcanza con cargar al menos uno.
