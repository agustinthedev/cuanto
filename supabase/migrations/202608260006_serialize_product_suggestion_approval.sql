-- Serialize concurrent approvals for the same canonical product identity.
-- This migration replaces the approval RPC from 202608260005.
...
begin
  ...
  -- Serialize the lookup-and-create sequence for the same normalized title
  -- and category without requiring a potentially failing legacy index.
